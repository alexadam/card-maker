...
const prepareDoc = (pdfData, onDocReady) => {
    let pageProperties = pdfData.properties
    let doc = createPDFDoc(pageProperties.orientation, pageProperties.format, pageProperties.width, pageProperties.height, pageProperties.unit)
...
const savePdf = (pdfData) => {
    prepareDoc(pdfData, (doc) => doc.save('cards.pdf'))
}
